...
{
  //emoji表情转换
  public function emoji($str,$is='en'){
	if('en'==$is){
...
public function ordersn($table, $field, $prefix)
	{
...
public function file_size($size, $dec=2) {
...
public function get_avatar($email='', $s=40, $d='mm', $g='g') {
	$hash = md5($email);
...
* 数组转换xml
*/	
	public function arr2xml($arr, $level = 1, $ptagname = '') {
		$s = $level == 1 ? "<xml>" : '';
