...
/**
  ...
  public function nextPage($style='nextPage')
 {
	...
	{
		return '<li class="'.$style.'">'.$this->_getLink($this->_getUrl($this->nowIndex+1),$this->nextPage,'').'</li>';
	}
    return '';
}
 ...
 * @return string
  */
  public function prePage($style='previous')
 {
 	 if($this->nowIndex>1)
 	 {
  		 return '<li class="'.$style.'">'.$this->_getLink($this->_getUrl($this->nowIndex-1),$this->prePage,'').'</li>';
 	 }
	return '';
  ...
  public function firstPage($style='firstPage')
 {
	  ...
	  return '<li>'.$this->_getLink($this->_getUrl(1),$this->firstPage,'').'</li>';
 }
  ...
  public function lastPage($style='lastPage')
 {
	  ...
	  return '<li>'.$this->_getLink($this->_getUrl($this->totalPage),$this->lastPage,'').'</li>';
 }
 ...
 */
	public function show($url="",$total=0,$perPage=10,$pageBarNum=10,$mode=4)
	{
