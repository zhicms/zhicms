...
/**
  ...
  * @return string
  */
  public function nextPage($style='nextpagestatic')
 {
 ...
 * @return string
  */
  public function prePage($style='prevpagestatic')
 {
 	 if($this->nowIndex>1)
 	 {
  ...
  public function lastPage($style='lastPage')
 {
  ...
  public function nowBar($style='pageNum otherPageNum ',$nowIndex_style='pageNum  currentPageNum')
 {
	...
	for($i=$begin;$i<$begin+$this->pageBarNum;$i++)
	{
		if($i<=$this->totalPage)
		{
			if($i!=$this->nowIndex)
				...
				$return.=$this->_getText('<li><a class="'.$nowIndex_style.'" href="#">'.$i.'</a></li>');
		}
		else
		{
			break;
